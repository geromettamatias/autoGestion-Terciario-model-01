...
<div class="table-responsive">
    <table class="table table-secondary table-sm table-hover">
      ...
      <tr>
        ...
        <td>
          <button class="btn btn-warning glyphicon glyphicon-pencil" data-toggle="modal" data-target="#modalEdicionAlumno" onclick="agregaformALUAlumnoInasistenciaEditar('<?php echo $datos ?>')">
        ...
        <td>
          ...
          onclick="preguntarSiNoAlumnoInasistenciaAlumnoEliminar('<?php echo $ver[0] ?>')">
