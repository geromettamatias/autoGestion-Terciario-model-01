<?php 
  ...
  if (isset($_SESSION['dniLoginTbedel']) && $_SESSION['usuarioAbedel']=='bedel') 
  {

    $dniLoginT=$_SESSION['dniLoginTbedel'];
    $usuarioA=$_SESSION['usuarioAbedel'];

    $_SESSION['dniLoginTbedel']=$dniLoginT;
    $_SESSION['usuarioAbedel']=$usuarioA;
            ...
            <div class="col-md-12">
              ...
              <dir id="menuPrincipalBedel">
                ...
                <button type="button" class="btn btn-danger btn-block" onclick='menuCargaBedelNOTASASISTENCIA();'>
                  ...
                  ALUMNOS <span class="badge badge-light">ASISTENCIA Y NOTAS </span></button><br>
                ...
                <button type="button" class="btn btn-danger btn-block" onclick='mesaExamen();'>
                  ...
                  CREAR-EDITAR-ELIMINAR <span class="badge badge-light">MESA DE EXAMEN - FECHAS DE FINALES Y CURSADAS- LIMPIEZA</span></button><br>
              </dir>
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $('#buscarAlumnosAsistencia').load('cargaAlumno/alumnoTablaBUSCAR.php');
      ...
      $('#BuscartablaMesa').load('mesaExamen/buscarmesaExamen.php');
      $('#extratablaMesa').load('mesaExamen/extrasmesaExamen.php');

      $('#fechaInscrCursado').load('mesaExamen/fechaTabla.php');
      $('#fechaInscrFinal').load('mesaExamen/fechaExtra.php');
