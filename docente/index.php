...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" type="text/css" href="../libreriasConexion/librerias/select2/css/select2.css">
    ...
    <link rel="stylesheet" type="text/css" href="../libreriasConexion/datatables/datatables.min.css"/>
    <!--datables estilo bootstrap 4 CSS-->  
    <link rel="stylesheet"  type="text/css" href="../libreriasConexion/datatables/DataTables-1.10.18/css/dataTables.bootstrap4.min.css">  
...
<script src="js/funcionesDatosPersonal.js"></script>
<script src="js/funfionnotas.js"></script>
...
<div class="container1">
    <div class="row">
     ...
     <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
        <a href="#" class="navbar-brand">Docente (DNI: <?php echo $dniLoginT; ?>)</a>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <dir id="menuPrincipalBedel">
                 ...
                 <!-- Menu-->
                <button type="button" class="btn btn-outline-danger btn-block" onclick='menuCargaBedelNOTASASISTENCIA();'>
                ...
                <button type="button" class="btn btn-outline-danger btn-block" onclick='mesaExamen();'>
                  <svg class="bi bi-arrow-down-square-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 5a.5.5 0 0 0-1 0v4.793L5.354 7.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 9.793V5z"/>
                </svg>

                  ASIGNATURAS </button><br>
              </dir>
              ...
              <path fill-rule="evenodd" d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.354 10.646a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L6.207 7.5H11a.5.5 0 0 1 0 1H6.207l2.147 2.146z"/>
                ...
                <div id="tablaAsignaturaNotaBuscar"></div>
                <div id="tablaAsignaturaNota"></div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#tablaAsignatura').load('asignaturas/tablaAsignaturas.php');
...
<script src="../libreriasConexion/librerias/jquery-3.2.1.min.js"></script>
 ...
 <script type="text/javascript" src="../libreriasConexion/datatables/datatables.min.js"></script> 
